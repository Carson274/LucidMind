...
define(['dart_sdk'], (function load__packages__logging__logging(dart_sdk) {
  ...
  dart.defineLazy(CT, {
    ...
    get C10() {
      return C[10] = dart.constList(dart_rti._Universe.eval(dart_rti._theUniverse(), "logging__src__level|Level", true), [C[0] || CT.C0, C[2] || CT.C2, C[3] || CT.C3, C[4] || CT.C4, C[5] || CT.C5, C[6] || CT.C6, C[7] || CT.C7, C[8] || CT.C8, C[9] || CT.C9, C[1] || CT.C1]);
    }
  });
  ...
  level.Level = class Level extends core.Object {
    ...
    _equals(other) {
      ...
      return dart_rti._Universe.eval(dart_rti._theUniverse(), "logging__src__level|Level", true)[_is](other) && this.value === other.value;
    }
    ['<'](other) {
    ...
    compareTo(other) {
      dart_rti._Universe.eval(dart_rti._theUniverse(), "logging__src__level|Level", true)[_as](other);
      return this.value - other.value;
    }
    get hashCode() {
      return this.value;
  ...
  dart.setMethodSignature(level.Level, () => dart.global.Object.setPrototypeOf({
    '<': _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "core|bool(logging__src__level|Level)", true),
    '<=': _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "core|bool(logging__src__level|Level)", true),
    '>': _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "core|bool(logging__src__level|Level)", true),
    '>=': _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "core|bool(logging__src__level|Level)", true),
  ...
  logger.Logger = class Logger extends core.Object {
    ...
    static new(name) {
      return logger.Logger._loggers[$putIfAbsent](name, dart.fn(() => logger.Logger._named(name), dart_rti._Universe.eval(dart_rti._theUniverse(), "logging__src__logger|Logger()", true)));
    }
    static ['_#new#tearOff'](name) {
      return logger.Logger.new(name);
    }
    static detached(name) {
      return new logger.Logger._internal(name, null, new _js_helper.IdentityMap.new(dart_rti._Universe.eval(dart_rti._theUniverse(), "_js_helper|IdentityMap<core|String,logging__src__logger|Logger>", true)));
    }
    ...
    static _named(name) {
      ...
      return new logger.Logger._internal(thisName, parent, new _js_helper.IdentityMap.new(dart_rti._Universe.eval(dart_rti._theUniverse(), "_js_helper|IdentityMap<core|String,logging__src__logger|Logger>", true)));
    }
    ...
    get onLevelChanged() {
      this[_levelChangedController] == null ? this[_levelChangedController] = async.StreamController.broadcast(dart_rti._Universe.eval(dart_rti._theUniverse(), "async|StreamController<logging__src__level|Level?>", true), {sync: true}) : null;
    ...
    log(logLevel, message, error = null, stackTrace = null, zone = null) {
      ...
      if (this.isLoggable(logLevel)) {
        if (dart_rti._Universe.eval(dart_rti._theUniverse(), "core|Function", true)[_is](message)) {
          message = dart_rti._Universe.eval(dart_rti._theUniverse(), "core|Object?()", true)[_as](message)();
        }
        let msg = null;
    ...
    [_getStream]() {
      let t$360;
      if (logger.hierarchicalLoggingEnabled || this.parent == null) {
        return (t$360 = this[_controller], t$360 == null ? this[_controller] = async.StreamController.broadcast(dart_rti._Universe.eval(dart_rti._theUniverse(), "async|StreamController<logging__src__log_record|LogRecord>", true), {sync: true}) : t$360).stream;
      } else {
  ...
  (logger.Logger._internal = function(name, parent$, children$) {
    ...
    this[children] = new collection.UnmodifiableMapView.new(dart_rti._Universe.eval(dart_rti._theUniverse(), "collection|UnmodifiableMapView<core|String,logging__src__logger|Logger>", true), children$);
    if (this.parent == null) {
  ...
  dart.setMethodSignature(logger.Logger, () => dart.global.Object.setPrototypeOf({
    ...
    isLoggable: _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "core|bool(logging__src__level|Level)", true),
    log: _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "~(logging__src__level|Level,core|Object?[core|Object?,core|StackTrace?,async|Zone?])", true),
    finest: _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "~(core|Object?[core|Object?,core|StackTrace?])", true),
    finer: _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "~(core|Object?[core|Object?,core|StackTrace?])", true),
    fine: _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "~(core|Object?[core|Object?,core|StackTrace?])", true),
    config: _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "~(core|Object?[core|Object?,core|StackTrace?])", true),
    info: _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "~(core|Object?[core|Object?,core|StackTrace?])", true),
    warning: _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "~(core|Object?[core|Object?,core|StackTrace?])", true),
    severe: _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "~(core|Object?[core|Object?,core|StackTrace?])", true),
    shout: _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "~(core|Object?[core|Object?,core|StackTrace?])", true),
    [_getStream]: _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "async|Stream<logging__src__log_record|LogRecord>()", true),
    [_publish]: _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "~(logging__src__log_record|LogRecord)", true)
  ...
  dart.setGetterSignature(logger.Logger, () => dart.global.Object.setPrototypeOf({
    fullName: _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "core|String", true),
    level: _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "logging__src__level|Level", true),
    onLevelChanged: _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "async|Stream<logging__src__level|Level?>", true),
    onRecord: _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "async|Stream<logging__src__log_record|LogRecord>", true)
  ...
  dart.setFieldSignature(logger.Logger, () => dart.global.Object.setPrototypeOf({
    ...
    parent: {
      type: _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "logging__src__logger|Logger?", true),
      isConst: false,
      isFinal: true,
      libraryUri: I[3]
    },
    [_level]: {
      type: _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "logging__src__level|Level?", true),
      isConst: false,
      isFinal: false,
      libraryUri: I[0]
    },
    [_children]: {
      type: _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "core|Map<core|String,logging__src__logger|Logger>", true),
      isConst: false,
      isFinal: true,
      libraryUri: I[1]
    },
    ...
    [_controller]: {
      type: _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "async|StreamController<logging__src__log_record|LogRecord>?", true),
      isConst: false,
      isFinal: false,
      libraryUri: I[4]
    },
    [_levelChangedController]: {
      type: _ti => dart_rti._Universe.eval(dart_rti._theUniverse(), "async|StreamController<logging__src__level|Level?>?", true),
      isConst: false,
      isFinal: false,
      libraryUri: I[4]
    }
  ...
  dart.defineLazy(logger.Logger, {
    ...
    /*logger.Logger._loggers*/get _loggers() {
      return new _js_helper.IdentityMap.new(dart_rti._Universe.eval(dart_rti._theUniverse(), "_js_helper|IdentityMap<core|String,logging__src__logger|Logger>", true));
    }
  });
