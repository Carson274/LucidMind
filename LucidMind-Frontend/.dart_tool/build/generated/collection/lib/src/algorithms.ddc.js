...
define(['dart_sdk', 'packages/collection/src/utils'], (function load__packages__collection__src__algorithms(dart_sdk, packages__collection__src__utils) {
  ...
  dart.defineLazy(CT, {
    ...
    get C1() {
      return C[1] = dart.gFn(utils.identity, dart_rti._Universe.eval(dart_rti._theUniverse(), "0^(0^)<core|Object?>", true), dart.constList(dart_rti._Universe.eval(dart_rti._theUniverse(), "@", true), [dart_rti._Universe.eval(dart_rti._theUniverse(), "@", true)]));
    }
  });
